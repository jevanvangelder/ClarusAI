...
async def spar_chat(body: SparChatMessage):
    try:
        ...
        system_prompt = (
            ...
            "  * Zet de casus tekst in het 'vraag' veld van de EERSTE casus vraag\n"
            "  * Begin dat vraag veld met: 'Casus: [hier het volledige verhaal van 200-400 woorden]'\n"
            "  * Voorbeeld: 'Casus: StartUp X is een startup die zich richt op... [volledig verhaal]. Vraag niet in dit veld!'\n"
            "  * De LATERE casus vragen bevatten alleen de echte vraag, geen casus tekst herhaling\n\n"
