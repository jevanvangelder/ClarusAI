          ...
          {filteredChats.map((chat) => (
            ...
            >
              ...
              <button
                ...
                className="three-dots-button absolute right-2 top-1/2 -translate-y-1/2 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-muted rounded transition-colors z-50 pointer-events-auto"
              >
