              ...
              >
                ...
                <div className="flex gap-3 pt-1">
                  <button
                    ...
                    className="text-xs text-blue-500 hover:text-blue-400 flex items-center gap-1 transition-colors min-h-[44px] px-1"
                  >
                    <Pencil size={14} />
                    Bewerken
                  </button>
                  <button
                    ...
                    className="text-xs text-red-500 hover:text-red-400 flex items-center gap-1 transition-colors min-h-[44px] px-1"
                  >
                    <Trash size={14} />
                    Verwijderen
                  </button>
